...
Older releases: [CHANGELOG.md](https://github.com/blissito/ghostycode/blob/main/CHANGELOG.md) and [docs/CHANGELOG_ARCHIVE.md](https://github.com/blissito/ghostycode/blob/main/docs/CHANGELOG_ARCHIVE.md).
