...
<title>ghosty Session Export</title>
<style>
  body {{
...
<div class="footer">
  Generated by ghosty · https://github.com/blissito/ghostycode
</div>
</body>
</html>"#,
    )
...
mod tests {
    ...
    fn test_render_session_html_metadata() {
        ...
        assert!(html.contains("https://github.com/blissito/ghostycode"));
    }
}
