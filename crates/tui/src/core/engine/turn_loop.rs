...
impl Engine {
    pub(super) async fn handle_deepseek_turn(
        ...
        crate::tui::notifications::start_title_animation("Ghosty Code");
        ...
        if !tool_catalog.is_empty() {
            ...
            // rejects Ghosty Code's full agent catalog). Runs after advanced
        ...
        'turn_loop: loop {
            ...
            if tool_uses.is_empty() {
                ...
                // `<ghosty:subagent.done>` sentinels into the transcript and
