...
fn english(id: MessageId) -> &'static str {
    match id {
        ...
        MessageId::HomeDashboardTitle => "ghosty Home Dashboard",
        ...
        MessageId::OnboardApiKeySavedHint => {
            "Saved to ~/.ghosty/config.toml so it works from any folder."
        }
        MessageId::OnboardApiKeyFormatHint => {
...
fn vietnamese(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::HomeDashboardTitle => "Bảng Điều Khiển Trang Chủ ghosty",
        ...
        MessageId::OnboardApiKeySavedHint => {
            "Được lưu vào ~/.ghosty/config.toml để có thể hoạt động từ mọi thư mục."
        }
        MessageId::OnboardApiKeyFormatHint => {
...
fn japanese(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::HomeDashboardTitle => "ghosty ホームダッシュボード",
        ...
        MessageId::OnboardApiKeySavedHint => {
            "~/.ghosty/config.toml に保存されるので、どのフォルダからでも有効になります。"
        }
        MessageId::OnboardApiKeyFormatHint => {
...
fn chinese_simplified(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::HomeDashboardTitle => "ghosty 主面板",
        ...
        MessageId::OnboardApiKeySavedHint => {
            "保存到 ~/.ghosty/config.toml，因此在任何目录下都生效。"
        }
...
fn portuguese_brazil(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::HomeDashboardTitle => "Painel Inicial do ghosty",
        ...
        MessageId::OnboardApiKeySavedHint => {
            "Salvo em ~/.ghosty/config.toml para funcionar em qualquer pasta."
        }
        MessageId::OnboardApiKeyFormatHint => {
...
fn spanish_latin_america(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CmdNoteDescription => "Agregar nota al archivo persistente (.ghosty/notes.md)",
        ...
        MessageId::HomeDashboardTitle => "Panel Inicial de ghosty",
        MessageId::HomeModel => "Modelo:",
        MessageId::HomeMode => "Modo:",
        MessageId::HomeWorkspace => "Workspace:",
        ...
        MessageId::OnboardApiKeySavedHint => {
            "Guardada en ~/.ghosty/config.toml para funcionar en cualquier carpeta."
        }
        MessageId::OnboardApiKeyFormatHint => {
