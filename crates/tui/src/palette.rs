...
/// Ghosty mascot purple — sampled from the brand ghost (#A29BE8).
pub const GHOSTY_PURPLE_RGB: (u8, u8, u8) = (162, 155, 232); // #A29BE8
pub const GHOSTY_PURPLE: Color = Color::Rgb(
    GHOSTY_PURPLE_RGB.0,
    GHOSTY_PURPLE_RGB.1,
    GHOSTY_PURPLE_RGB.2,
);
...
pub const GHOSTY_UI_THEME: UiTheme = UiTheme {
    ...
    text_dim: Color::Rgb(0x4a, 0x47, 0x5c),
    text_hint: Color::Rgb(0x5a, 0x57, 0x70),
    ...
    info: Color::Rgb(0x3d, 0xdc, 0xd4),    // cyan
    // Mode badges
    mode_agent: Color::Rgb(0x9b, 0x5d, 0xe5), // purple
    mode_yolo: Color::Rgb(0xff, 0x4d, 0x6d),  // red
    mode_plan: Color::Rgb(0xf9, 0xc7, 0x4f),  // yellow
    mode_goal: Color::Rgb(0x43, 0xd9, 0x87),  // green
    // Footer statusline
...
impl ThemeId {
    ...
    pub const fn tagline(self) -> &'static str {
        match self {
            ...
            Self::Ghosty => "Deep black & violet — Ghosty signature",
            Self::SolarizedLight => {
