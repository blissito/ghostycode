...
mod tests {
    ...
    async fn mobile_page_is_available_only_when_enabled() -> Result<()> {
        ...
        assert!(html.contains("Ghosty Code Mobile"));
    ...
    async fn mobile_page_requires_runtime_token_when_auth_enabled() -> Result<()> {
        ...
        let query = client
            ...
            .await?
            .error_for_status()?;
        assert!(query.text().await?.contains("Ghosty Code Mobile"));
        ...
        let bearer = client
            ...
            .await?
            .error_for_status()?;
        assert!(bearer.text().await?.contains("Ghosty Code Mobile"));
    ...
    async fn mobile_insecure_mode_allows_page_and_v1_routes_without_token() -> Result<()> {
        ...
        let page = client
            ...
            .await?
            .error_for_status()?;
        assert!(page.text().await?.contains("Ghosty Code Mobile"));
