...
//! `~/.ghosty/tool_outputs/<sanitised-id>.txt`. The id is the tool
...
/// Name of the spillover directory under the Ghosty Code home.
...
/// `~/.ghosty/sessions/<session-id>/artifacts/`, and the inline tool result
