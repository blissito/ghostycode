...
/// Ghost-cycle frames: 👻 builds up dots, then fades to 🫥 before reappearing.
/// The vanishing ghost is the punchline at the midpoint of each cycle.
...
mod tests {
    ...
    fn wide_header_shows_plain_mode_and_single_metadata_cluster() {
        ...
        assert!(rendered.contains("ghosty-tui"));
