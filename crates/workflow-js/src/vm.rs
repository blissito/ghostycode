...
const VM_MEMORY_LIMIT_MB_ENV: &str = "GHOSTY_WORKFLOW_JS_MEMORY_LIMIT_MB";
const VM_STACK_KB_ENV: &str = "GHOSTY_WORKFLOW_JS_STACK_KB";
const VM_THREAD_STACK_KB_ENV: &str = "GHOSTY_WORKFLOW_JS_THREAD_STACK_KB";
const VM_MAX_CONCURRENT_ENV: &str = "GHOSTY_WORKFLOW_JS_MAX_CONCURRENT";
