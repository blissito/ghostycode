...
The vision is at risk of being lost between point releases. Ghosty Code is
...
| `/rules` | Repo guidance |
| `.ghosty/constitution.json` | Repo constitution: checked-in **local law** |
...
base myth / global Constitution
  -> repo constitution (.ghosty/constitution.json)
  -> task packet
  -> runtime policy
```
...
/context
  ...
  repo-constitution ▸ .ghosty/constitution.json (4 KB) [view]
