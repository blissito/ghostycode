...
GitHub-stewardship and release-QA workflows for maintaining Ghosty, codified as
`SKILL.md` skills (same format Claude Code and Ghosty both load). They encode the
...
- **Ghosty:** copy into a GhostyCode-owned root (e.g. `~/.ghosty/skills/`), import via
...
gh-treasure-hunt, gh-close-issues, gh-credit-harvest, ghosty-tui-release-qa-sweep.
