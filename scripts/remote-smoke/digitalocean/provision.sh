#!/usr/bin/env bash
# EXPERIMENTAL — DigitalOcean smoke-lab provisioning for the GhostyCode
...
#
# Tunables (env):
#   DROPLET_NAME    default ghosty-smoke
...
DROPLET_NAME="${DROPLET_NAME:-ghosty-smoke}"
