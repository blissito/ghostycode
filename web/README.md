...
Community site for [Ghosty Code](https://github.com/blissito/ghostycode) — lives at **ghosty.net**.
...
3. **Point the domain:** in the Cloudflare dashboard, add a Worker route for `ghosty.net/*` → the deployed Worker (currently named `deepseek-tui-web` unless the Worker is renamed during deploy).
