...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata({
    path: "/constitution",
    locale,
    title: isZh ? "三层法 · Ghosty" : "Three layers of law · Ghosty",
    description: isZh
      ? "Ghosty 的嵌套宪章：内置基础法、你的常备法（/constitution）、仓库自己的法（.ghosty/constitution.json）。位阶由执行框架强制生效，换掉模型也不失效。"
      : "Ghosty's nested constitution: bundled base law, your standing law (/constitution), and your repo's law (.ghosty/constitution.json). Rank is enforced in the harness and survives a model swap.",
  });
}
...
const LAYERS = [
  ...
  },
  {
    ...
    path: "$GHOSTY_HOME/constitution.json",
    pathZh: "$GHOSTY_HOME/constitution.json",
  ...
  },
  {
    ...
    path: ".ghosty/constitution.json",
    pathZh: ".ghosty/constitution.json",
    ...
    <>
      ...
      <section className="site-container py-8 hairline-t">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Link
            href="https://github.com/blissito/ghostycode/blob/main/docs/CONFIGURATION.md#constitution-project-instructions-and-repo-authority"
