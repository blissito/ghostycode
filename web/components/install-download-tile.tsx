...
const BASE =
  "https://github.com/blissito/ghostycode/releases/latest/download";

const ASSETS: Record<Arch, { zip: string; sha: string }> = {
  "macos-arm64": {
    zip: `${BASE}/ghosty-macos-arm64.zip`,
    sha: `${BASE}/ghosty-artifacts-sha256.txt`,
  },
  "macos-x64": {
    zip: `${BASE}/ghosty-macos-x64.zip`,
    sha: `${BASE}/ghosty-artifacts-sha256.txt`,
  },
  "linux-x64": {
    zip: `${BASE}/ghosty-linux-x64.zip`,
    sha: `${BASE}/ghosty-artifacts-sha256.txt`,
  },
  "linux-arm64": {
    zip: `${BASE}/ghosty-linux-arm64.zip`,
    sha: `${BASE}/ghosty-artifacts-sha256.txt`,
  },
  "windows-x64": {
    zip: `${BASE}/ghosty-windows-x64.zip`,
    sha: `${BASE}/ghosty-artifacts-sha256.txt`,
  },
};
