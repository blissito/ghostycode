...
export const chrome: ChromeDict = {
  ...
  footerTagline:
    "Ghosty se sumerge en las profundidades para que tú no tengas que hacerlo: documentación, código fuente y comunidad del runtime de código abierto.",
