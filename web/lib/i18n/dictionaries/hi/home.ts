 ...
 * Operate, Ask / Auto-Review / Full Access, Ghosty, TUI,
...
export const home: HomeDict = {
  metaTitle: "Ghosty — गहराई में यह उतरता है, आपको नहीं।",
  metaDescription:
    "गहराई में Ghosty उतरता है, आपको नहीं उतरना पड़ता — टर्मिनल के लिए ओपन सोर्स कोडिंग एजेंट। अपना मॉडल लाइए। आपकी मशीन पर चलता है। Rust, MIT।",

  kicker: "ओपन सोर्स · अपना मॉडल लाइए · टर्मिनल में चलता है",
  heroTitleA: "Ghosty गहराई में उतरता है",
  ...
  screenshotAlt:
    "Ghosty का वर्तमान टर्मिनल सेशन — Operate मोड, व्हेल, कंपोज़र और फ़ुटर दिख रहे हैं",
  figcaption: "Ghosty का वर्तमान सेशन · Operate मोड · Ask अनुमति-मुद्रा",
  ...
  sealStart: "起",
  startHeading: "Ghosty पर नए हैं? शुरू से अंत तक चार कदम।",
  startLede:
