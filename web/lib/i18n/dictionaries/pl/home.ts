...
export const home: HomeDict = {
  metaTitle: "Ghosty — zanurza się w głębinach, żebyś ty nie musiał.",
  metaDescription:
    "Ghosty zanurza się w głębinach, żebyś ty nie musiał — otwartoźródłowy agent do kodowania w terminalu. Przynieś własny model. Działa na twojej maszynie. Rust, MIT.",

  kicker: "Open source · Własny model · Działa w terminalu",
  heroTitleA: "Ghosty zanurza się w głębinach,",
  ...
  screenshotAlt:
    "Bieżąca sesja Ghosty w terminalu: tryb Operate, wieloryb, kompozytor i stopka",
  figcaption: "Bieżąca sesja Ghosty · tryb Operate · postawa uprawnień Ask",
  ...
  sealStart: "起",
  startHeading: "Nowy w Ghosty? Cztery kroki od początku do końca.",
  startLede:
