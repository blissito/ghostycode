...
export const home: HomeDict = {
  metaTitle: "Ghosty — занурюється в глибину, щоб не довелося вам.",
  metaDescription:
    "Ghosty занурюється в глибину, щоб не довелося вам — термінальний агент із відкритим кодом, що пише код. Підключіть власну модель. Працює на вашій машині. Rust, MIT.",

  kicker: "Відкритий код · Ваша власна модель · Працює у вашому терміналі",
  heroTitleA: "Ghosty занурюється в глибину,",
  ...
  screenshotAlt:
    "Поточний термінальний сеанс Ghosty: режим Operate, кит, композер і нижня панель",
  figcaption: "Поточний сеанс Ghosty · режим Operate · дозволи Ask",
  ...
  sealStart: "起",
  startHeading: "Уперше в Ghosty? Чотири кроки від початку до кінця.",
  startLede:
